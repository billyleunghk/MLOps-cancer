...
# important to MLFLOW and DAGSHUB step
import mlflow
...
class ModelTraining:
    ...
    def  train_model(self):
        try:
            ...
            logger.info("Model trained and saved succesfully...")
    ...
    def evaluate_model(self):
        try:
            ...
            # For experiment tracking using MLFLOW and DAGSHUB
...
if __name__=="__main__":
    # with mlflow for next step using but not Data Processing
